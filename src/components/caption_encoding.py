...
class CaptionEncoder:
    ...
    def create_dataset(self, X, Y):
        try:
            ...
            dataset = dataset.shuffle(self.caption_encoder_config.shuffle_size).batch(self.caption_encoder_config.batch_size)
    ...
    def initiate_caption_encoding(self, train_dict, test_dict):
        try:
            # cleaning captions
